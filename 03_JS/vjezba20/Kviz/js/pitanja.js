const skupPitanja = [{
    ...
    {
        pitanje: 'Što radi console.log() u JS?',
        tocno: 'Ispisuje vrijednost ili poruku u konzolu',
        odgovori: ['Briše podatke iz programa', 'Ispisuje vrijednost ili poruku u konzolu', 'Stvara novu varijablu']
    }
];